                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    @csrf
                                    <input type="text" class="form-control" name="" value="{{ $client->client_name }}">
                                    <input type="text" class="form-control" name="" value="{{ $client->phone }}">
                                    <input type="text" class="form-control" name="" value="{{ $client->email }}">
